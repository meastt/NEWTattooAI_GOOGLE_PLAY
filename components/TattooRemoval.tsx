    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="text-center mb-12 relative">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
          Curious what a cover-up might look like? See a preview of your skin without a specific tattoo.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-8 rounded-3xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl">
          ...
          <div className="space-y-6">
            <div>
              <label htmlFor="removalDescription" className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Describe the tattoo and its location *</label>
              <textarea
            ...
            >
              {isLoading ? (
                <div className="flex items-center space-x-3">
                  ...
                  <span>Visualizing Removal...</span>
                </div>
              ) : (
                <div className="flex items-center space-x-2">
                  <span>Visualize Removal</span>
